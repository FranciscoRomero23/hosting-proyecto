...
<p>Desde esta página podras instalar un Mediawiki en tu servidor. Para que se pueda realizar la instalación, necesito que nos facilites los siguientes datos:</p>
<form action="/mediawiki" method="post">
        Base de datos<br/>
